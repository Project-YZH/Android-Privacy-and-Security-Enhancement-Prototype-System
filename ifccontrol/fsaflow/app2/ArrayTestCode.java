...
public class ArrayTestCode {
	...
	*/
	...
	/* 测试函数
	public void concreteWriteReadSamePosIntArrayTest(){
		int yangvar1 = TelephonyManager.getIMEI();
		Yang yang=new Yang();
		int yangvar22=yang.test_loop2(yangvar1,99,"okok",yangvar1);
		ConnectionManager cm = new ConnectionManager();
		//cm.publish(zhi);
		//cm.publish(chenxia);
		cm.publish(yangvar22);
	...
	*/
	...
	/**/
	public int concreteWriteReadSamePosIntArrayTest(){
		int yangvar1 = TelephonyManager.getIMEI();
		//int yangvar1 = 22;
		//int zhi=2;
		//int chenxia=1;
		...
		int yangvar22=yang.test2(yangvar1);
		//yangtest(zhi);
		ConnectionManager cm = new ConnectionManager();
		//cm.publish(zhi);
		//cm.publish(chenxia);
		int yangvar_othersource = TelephonyManager.getIMEI();
		//yangvar22+=yangvar_othersource;
	//	cm.publish(yangvar22);
		...
		if (x/2==0)
		{
			yangoutputvar=yangvar1;
		}
		else
		{
			yangoutputvar=yangvar_othersource;
		}
		/**/
		yangoutputvar=yangvar_othersource+yangvar1;
		cm2.publish(yangoutputvar);
		return 88;
